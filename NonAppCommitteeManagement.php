  ...
  ga('send', 'pageview');
	...
	<body>
		...
		<div class="container" id="template-container">
			<div class="container">
				<h1 class="text-center">Non-Application Committee Management</h1>
				<div class="horbar">
				</div><br>
				<h2><i class="fa fa-globe"></i>  <a href="submitCountryLists.php">Country List Submission</a></h2>
				<p><i>Submit and edit lists of the countries represented by each committee.</i></p>
				<h2><i class="fa fa-pencil-square-o"></i>  <a href="nonAppCommitteeAssignments.php">Committee Assignments</a></h2>
				<p><i>Assign delegates to the non-application committees.</i></p>
