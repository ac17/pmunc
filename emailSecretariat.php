  ...
  ga('send', 'pageview');
	...
	<body>
		...
		<div class="container" id="template-container">
			<div class="container">
				<h1 class="text-center">Contact the PMUNC Secretariat</h1>
				<div class="horbar"></div><br>
				<form name="editForm" role="form" action="emailDelivery.php" method="post">
					<?php
					...
					?>
					<h3><b>Subject</b>:<br> <input type="text" name="subj" required></h3>
					<h3><b>Message</b>:</h3>
					<p>Maximum length of 2000 characters.</p>
					<textarea name="msg" class="form-control" width="100%" maxlength="2000" required></textarea><br><br>
					<input type="hidden" name="emailSubmit" id="emailSubmit" value="true"><br>
