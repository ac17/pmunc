<?php
	...
	if(!$errors){  
	    ...
	    if(mysql_num_rows($result) == 1){  
	    	...
	    	$result2 = mysql_query('SELECT * FROM users WHERE email="' . mysql_real_escape_string($loginEmail) . '";');
		...
		<div class="container" id="signin-container">
			<div class="container">
				...
				<div class="horbar">
					...
					<center><a href="forgotPassword.php"><button type="button" class="btn btn-link">Forgot your password?</button></a></center>
			</div>
		</div>
