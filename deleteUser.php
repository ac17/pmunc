...
$index = $_GET["userNum"];
$query1="SELECT * FROM users ORDER BY user_type, first_name, last_name ASC LIMIT " . $index . ",1;";
$result = mysql_query($query1);
$row = mysql_fetch_assoc($result);
$query2="DELETE from users where id=\"" . $row['id'] . "\";";
mysql_query($query2);
if ($row['user_type'] == 2) {
	$query3 = 'DELETE from SCHOOL_INFO WHERE Preferred_Email="' . $row['email'] . '" LIMIT 1;';
	mysql_query($query3);
}
?>
<!DOCTYPE html>
  ...
  ga('send', 'pageview');
	...
	<body>
		...
		<div class="container" id="template-container">
			<div class="container">
				<h1 class="text-center">Request Successful</h1>
				<div class="horbar">
				</div><br>
				<center>
					The user was deleted successfully.<br>
					<a href="userManagement.php"><button type="button" class="btn btn-link">Back to User Management</button></a>
